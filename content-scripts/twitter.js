...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    try {
        ...
        if (message.action === 'forceClear' && twitterBlocker) {
            console.log('Twitter: Received forceClear message, clearing all blocks');
        ...
        if (message.action === 'deepFocusActivated') {
            try {
                ...
                console.error('Twitter: Error reloading for deep focus:', e);
            }
        }
    } catch (error) {
