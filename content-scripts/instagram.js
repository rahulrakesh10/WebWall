...
chrome.runtime.onMessage.addListener((message, sender, sendResponse) => {
    try {
        ...
        if (message.action === 'forceClear' && instagramBlocker) {
            console.log('Instagram: Received forceClear message, clearing all blocks');
        ...
        if (message.action === 'deepFocusActivated') {
            try {
                ...
                console.error('Instagram: Error reloading for deep focus:', e);
            }
        }
    } catch (error) {
